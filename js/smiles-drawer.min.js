(function() {
    ...
    1: [function(require, module) {
        ...
        Array.prototype.fill || Object.defineProperty(Array.prototype, "fill", {
            value: function(value) {
                ...
                for (var O = Object(this), len = O.length >>> 0, start = arguments[1], relativeStart = start >> 0, k = 0 > relativeStart ? _Mathmax(len + relativeStart, 0) : _Mathmin(relativeStart, len), end = arguments[2], relativeEnd = void 0 === end ? len : end >> 0, final = 0 > relativeEnd ? _Mathmax(len + relativeEnd, 0) : _Mathmin(relativeEnd, len); k < final; )
                    O[k] = value,
                    k++;
                return O
            }
    ...
    2: [function(require, module) {
        ...
        class ArrayHelper {
            ...
            static toggle(arr, value) {
                ...
                return removed || newArr.push(value),
                newArr
            }
            ...
            static removeUnique(arr, value) {
                ...
                return -1 < index && arr.splice(index, 1),
                arr
            }
    ...
    4: [function(require, module) {
        ...
        module.exports = class {
            constructor(target, themeManager, options) {
                this.canvas = "string" == typeof target || target instanceof String ? document.getElementById(target) : target,
            ...
            updateSize(width, height) {
                ...
                1 === this.ratio ? (this.canvas.width = width * this.ratio,
                this.canvas.height = height * this.ratio) : (this.canvas.width = width * this.ratio,
            ...
            scale(vertices) {
                ...
                this.offsetX = -minX,
                this.offsetY = -minY,
                scaleX < scaleY ? this.offsetY += this.canvas.offsetHeight / (2 * scale) - this.drawingHeight / 2 : this.offsetX += this.canvas.offsetWidth / (2 * scale) - this.drawingWidth / 2
            }
            reset() {
            ...
            drawCircle(x, y, radius, color, fill=!0, debug=!1, debugText="") {
                ...
                ctx.closePath(),
                debug ? (fill ? (ctx.fillStyle = "#f00",
                ctx.fill()) : (ctx.strokeStyle = "#f00",
                ctx.stroke()),
                this.drawDebugText(x, y, debugText)) : fill ? (ctx.fillStyle = color,
                ctx.fill()) : (ctx.strokeStyle = color,
                ctx.stroke()),
                ctx.restore()
            }
            drawLine(line, dashed=!1, alpha=1) {
                ...
                gradient.addColorStop(.4, this.themeManager.getColor(line.getLeftElement()) || this.themeManager.getColor("C")),
                gradient.addColorStop(.6, this.themeManager.getColor(line.getRightElement()) || this.themeManager.getColor("C")),
                dashed && (ctx.setLineDash([1, 1.5]),
            ...
            drawDashedWedge(line) {
                ...
                normals[0].normalize(),
                normals[1].normalize();
                let isRightChiralCenter = line.getRightChiral(), shortLine = line.clone(), start, end, sStart, sEnd;
                isRightChiralCenter ? (start = r,
                end = l,
                shortLine.shortenRight(1),
                sStart = shortLine.getRightVector().clone(),
                sEnd = shortLine.getLeftVector().clone()) : (start = l,
                end = r,
            ...
            drawBall(x, y, elementName) {
                ...
                ctx.save(),
                ctx.beginPath(),
                ctx.arc(x + this.offsetX, y + this.offsetY, this.opts.bondLength / 4.5, 0, MathHelper.twoPI, !1),
            ...
            drawPoint(x, y, elementName) {
                ...
                ctx.globalCompositeOperation = "source-over",
                ctx.beginPath(),
                ctx.arc(x + this.offsetX, y + this.offsetY, .75, 0, MathHelper.twoPI, !1),
                ctx.fillStyle = this.themeManager.getColor(elementName),
                ctx.fill(),
                ctx.restore()
            }
            drawText(x, y, elementName, hydrogens, direction, isTerminal, charge, isotope, attachedPseudoElement={}) {
                ...
                let chargeText = ""
                  , chargeWidth = 0;
                charge && (chargeText = getChargeText(charge),
                ctx.font = this.fontSmall,
                chargeWidth = ctx.measureText(chargeText).width);
                let isotopeText = "0"
                  , isotopeWidth = 0;
                0 < isotope && (isotopeText = isotope.toString(),
                ctx.font = this.fontSmall,
                isotopeWidth = ctx.measureText(isotopeText).width),
                1 === charge && "N" === elementName && attachedPseudoElement.hasOwnProperty("0O") && attachedPseudoElement.hasOwnProperty("0O-1") && (attachedPseudoElement = {
                    "0O": {
                        element: "O",
                        count: 2,
                        hydrogenCount: 0,
                ...
                if (1 === hydrogens) {
                    ...
                    "left" === direction ? hx += cursorPosLeft : "right" === direction ? hx += cursorPos : "up" === direction && isTerminal ? hx += cursorPos : "down" === direction && isTerminal ? hx += cursorPos : "up" !== direction || isTerminal ? "down" === direction && !isTerminal && (hy += this.opts.fontSizeLarge + this.opts.quarterFontSizeLarge,
                    hx -= this.halfHydrogenWidth) : (hy -= this.opts.fontSizeLarge + this.opts.quarterFontSizeLarge,
                ...
                for (let key in attachedPseudoElement) {
                    ...
                    ctx.font = this.fontLarge,
                    1 < elementCount && 0 < hydrogenCount && (openParenthesisWidth = ctx.measureText("(").width,
                    ...
                    0 !== elementCharge && (elementChargeText = getChargeText(elementCharge),
                    ...
                    1 < elementCount && 0 < hydrogenCount && ("left" === direction ? (cursorPosLeft -= closeParenthesisWidth,
                    ctx.fillText(")", hx + cursorPosLeft, hy)) : (ctx.fillText("(", hx + cursorPos, hy),
                    cursorPos += openParenthesisWidth)),
                    "left" === direction ? (cursorPosLeft -= elementWidth,
                    ctx.fillText(element, hx + cursorPosLeft, hy)) : (ctx.fillText(element, hx + cursorPos, hy),
                    cursorPos += elementWidth),
                    0 < hydrogenCount && ("left" === direction ? (cursorPosLeft -= hydrogenWidth + hydrogenCountWidth,
                    ctx.fillText("H", hx + cursorPosLeft, hy),
                    1 < hydrogenCount && (ctx.font = this.fontSmall,
                    ctx.fillText(hydrogenCount, hx + cursorPosLeft + hydrogenWidth, hy + this.opts.fifthFontSizeSmall))) : (ctx.fillText("H", hx + cursorPos, hy),
                    cursorPos += hydrogenWidth,
                    1 < hydrogenCount && (ctx.font = this.fontSmall,
                    ctx.fillText(hydrogenCount, hx + cursorPos, hy + this.opts.fifthFontSizeSmall),
                    cursorPos += hydrogenCountWidth))),
                    ctx.font = this.fontLarge,
                    1 < elementCount && 0 < hydrogenCount && ("left" === direction ? (cursorPosLeft -= openParenthesisWidth,
                    ctx.fillText("(", hx + cursorPosLeft, hy)) : (ctx.fillText(")", hx + cursorPos, hy),
                    cursorPos += closeParenthesisWidth)),
                    ctx.font = this.fontSmall,
                    1 < elementCount && ("left" === direction ? ctx.fillText(elementCount, hx + cursorPosLeft + openParenthesisWidth + closeParenthesisWidth + hydrogenWidth + hydrogenCountWidth + elementWidth, hy + this.opts.fifthFontSizeSmall) : (ctx.fillText(elementCount, hx + cursorPos, hy + this.opts.fifthFontSizeSmall),
                    cursorPos += elementCountWidth)),
                    0 !== elementCharge && ("left" === direction ? ctx.fillText(elementChargeText, hx + cursorPosLeft + openParenthesisWidth + closeParenthesisWidth + hydrogenWidth + hydrogenCountWidth + elementWidth, y - this.opts.fifthFontSizeSmall + offsetY) : (ctx.fillText(elementChargeText, hx + cursorPos, y - this.opts.fifthFontSizeSmall + offsetY),
            ...
            drawAromaticityRing(ring) {
                ...
                ctx.lineWidth = this.opts.bondThickness,
                ctx.beginPath(),
                ctx.arc(ring.center.x + this.offsetX, ring.center.y + this.offsetY, radius - this.opts.bondSpacing, 0, 2 * Math.PI, !0),
                ctx.closePath(),
                ctx.stroke(),
                ctx.restore()
            }
    ...
    5: [function(require, module) {
        ...
        module.exports = class {
            ...
            extend() {
                ...
                "[object Boolean]" === Object.prototype.toString.call(arguments[0]) && (deep = arguments[0],
                i++);
                for (let merge = function(obj) {
                    for (var prop in obj)
                        Object.prototype.hasOwnProperty.call(obj, prop) && (extended[prop] = deep && "[object Object]" === Object.prototype.toString.call(obj[prop]) ? that.extend(!0, extended[prop], obj[prop]) : obj[prop])
                }; i < length; i++) {
                    let obj = arguments[i];
                    merge(obj)
                }
            ...
            draw(data, target, themeName="light", infoOnly=!1) {
                ...
                this.infoOnly || (this.themeManager = new ThemeManager(this.opts.themes,themeName),
                this.canvasWrapper = new CanvasWrapper(target,this.themeManager,this.opts)),
                infoOnly || (this.processGraph(),
                this.canvasWrapper.scale(this.graph.vertices),
                this.drawEdges(this.opts.debug),
                this.drawVertices(this.opts.debug),
                this.canvasWrapper.reset(),
                this.opts.debug && (console.log(this.graph),
            ...
            rotateDrawing() {
                ...
                if (!isNaN(angle)) {
                    ...
                    for (var i = 0; i < this.graph.vertices.length; i++)
                        i !== b && this.graph.vertices[i].position.rotateAround(angle, this.graph.vertices[b].position);
                    for (var i = 0; i < this.rings.length; i++)
            ...
            getMolecularFormula() {
                ...
                for (var i = 0; i < this.graph.vertices.length; i++) {
                    ...
                    if (counts.has(atom.element) ? counts.set(atom.element, counts.get(atom.element) + 1) : counts.set(atom.element, 1),
                    atom.bracket && !atom.bracket.chirality && (counts.has("H") ? counts.set("H", counts.get("H") + atom.bracket.hcount) : counts.set("H", atom.bracket.hcount)),
                    !atom.bracket) {
                        let nHydrogens = Atom.maxBonds[atom.element] - atom.bondCount;
                        atom.isPartOfAromaticRing && nHydrogens--,
                        counts.has("H") ? counts.set("H", counts.get("H") + nHydrogens) : counts.set("H", nHydrogens)
                    }
                }
                if (counts.has("C")) {
                    ...
                    for (var i = 0; i < this.graph.edges.length; i++) {
                        ...
                        if (this.isEdgeRotatable(edge)) {
                            let subTreeDepthA = this.graph.getTreeDepth(edge.sourceId, edge.targetId)
                              ...
                              , a = edge.targetId
                              , b = edge.sourceId;
                            subTreeDepthA > subTreeDepthB && (a = edge.sourceId,
                            b = edge.targetId);
                                ...
                                if (1 === neighboursB.length) {
                                    ...
                                    if (1 === neighbourA.value.rings.length && 1 === neighbourB.value.rings.length) {
                                        if (neighbourA.value.rings[0] !== neighbourB.value.rings[0])
                                            continue;
                                    } else if (0 !== neighbourA.value.rings.length || 0 !== neighbourB.value.rings.length)
                                        continue;
                                    else {
                                        ...
                                        let newTotalOverlapScore = this.getOverlapScore().total;
                                        newTotalOverlapScore > this.totalOverlapScore ? (this.rotateSubtree(neighbourA.id, vertexB.id, -angleA, vertexB.position),
                                        this.rotateSubtree(neighbourB.id, vertexB.id, -angleB, vertexB.position)) : this.totalOverlapScore = newTotalOverlapScore
                                    }
                                }
            ...
            initHydrogens() {
                if (!this.opts.explicitHydrogens)
                    for (var i = 0; i < this.graph.vertices.length; i++) {
                        let vertex = this.graph.vertices[i];
                        if ("H" !== vertex.value.element)
                            continue;
                        let neighbour = this.graph.vertices[vertex.neighbours[0]];
                        neighbour.value.hasHydrogen = !0,
                        (!neighbour.value.isStereoCenter || 2 > neighbour.value.rings.length && !neighbour.value.bridgedRing || neighbour.value.bridgedRing && 2 > neighbour.value.originalRings.length) && (vertex.value.isDrawn = !1)
                    }
            }
                ...
                let involvedRings = []
                  ...
                  , recurse = function(r) {
                    ...
                    for (var i = 0; i < ring.neighbours.length; i++) {
                        ...
                        -1 === involvedRings.indexOf(n) && n !== r && RingConnection.isBridge(that.ringConnections, that.graph.vertices, r, n) && recurse(n)
                    }
                };
                return recurse(ringId),
                ArrayHelper.unique(involvedRings)
            }
            ...
            createBridgedRing(ringIds, sourceVertexId) {
                ...
                for (let id of leftovers) {
                    ...
                    onRing ? (vertex.value.isBridgeNode = !0,
                    ringMembers.add(vertex.id)) : (vertex.value.isBridge = !0,
            ...
            getCommonRings(vertexA, vertexB) {
                ...
                for (var i = 0; i < vertexA.value.rings.length; i++)
                    for (var j = 0; j < vertexB.value.rings.length; j++)
                        vertexA.value.rings[i] == vertexB.value.rings[j] && commonRings.push(vertexA.value.rings[i]);
                return commonRings
            }
            ...
            getClosestVertex(vertex) {
                ...
                for (var i = 0; i < this.graph.vertices.length; i++) {
                    ...
                    distSq < minDist && (minDist = distSq,
                    minVertex = v)
                }
                return minVertex
            }
            addRing(ring) {
                return ring.id = this.ringIdCounter++,
            ...
            addRingConnection(ringConnection) {
                return ringConnection.id = this.ringConnectionIdCounter++,
            ...
            getSubringCenter(ring, vertex) {
                ...
                for (var i = 0; i < rings.length; i++)
                    for (var j = 0; j < ring.rings.length; j++)
                        rings[i] === ring.rings[j].id && ring.rings[j].getSize() < smallest && (center = ring.rings[j].center,
            ...
            drawEdge(edgeId, debug) {
                ...
                if ((!vertexA.value.isDrawn || !vertexB.value.isDrawn) && "default" === this.opts.atomVisualization)
                    return;
                let a = vertexA.position
                  , b = vertexB.position
                  , normals = this.getEdgeNormals(edge)
                  , sides = ArrayHelper.clone(normals);
                if (sides[0].multiplyScalar(10).add(a),
                sides[1].multiplyScalar(10).add(a),
                "=" === edge.bondType || "=" === this.getRingbondType(vertexA, vertexB) || edge.isPartOfAromaticRing && this.bridgedRing) {
                    ...
                    if (inRing) {
                        ...
                        let line = null;
                        line = center.sameSideAs(vertexA.position, vertexB.position, Vector2.add(a, normals[0])) ? new Line(Vector2.add(a, normals[0]),Vector2.add(b, normals[0]),elementA,elementB) : new Line(Vector2.add(a, normals[1]),Vector2.add(b, normals[1]),elementA,elementB),
                        line.shorten(this.opts.bondLength - this.opts.shortBondLength * this.opts.bondLength),
                        edge.isPartOfAromaticRing ? this.canvasWrapper.drawLine(line, !0) : this.canvasWrapper.drawLine(line),
            ...
            drawVertices(debug) {
                for (var i = this.graph.vertices.length, i = 0; i < this.graph.vertices.length; i++) {
                    ...
                    if ("N" === atom.element && atom.isPartOfAromaticRing && (hydrogens = 0),
                    atom.bracket && (hydrogens = atom.bracket.hcount,
                    charge = atom.bracket.charge,
                    isotope = atom.bracket.isotope),
                    "allballs" === this.opts.atomVisualization)
                        this.canvasWrapper.drawBall(vertex.position.x, vertex.position.y, element);
                    else if (atom.isDrawn && (!isCarbon || atom.drawExplicit || isTerminal || atom.hasAttachedPseudoElements) || 1 === this.graph.vertices.length)
                        "default" === this.opts.atomVisualization ? this.canvasWrapper.drawText(vertex.position.x, vertex.position.y, element, hydrogens, dir, isTerminal, charge, isotope, atom.getAttachedPseudoElements()) : "balls" === this.opts.atomVisualization && this.canvasWrapper.drawBall(vertex.position.x, vertex.position.y, element);
            ...
            position() {
                ...
                for (var i = 0; i < this.rings.length; i++)
                    this.rings[i].isBridged && (startVertex = this.graph.vertices[this.rings[i].members[0]]);
                0 < this.rings.length && null === startVertex && (startVertex = this.graph.vertices[this.rings[0].members[0]]),
            ...
            createRing(ring, center=null, startVertex=null, previousVertex=null) {
                ...
                if (-1 === ring.members.indexOf(startVertexId) && (startVertex && (startVertex.positioned = !1),
                ...
                ring.isBridged) {
                    ...
                    ring.eachMember(this.graph.vertices, function(v) {
                        ...
                        vertex.positioned || vertex.setPosition(center.x + _Mathcos(a) * radius, center.y + _Mathsin(a) * radius),
                        a += angle,
                        (!ring.isBridged || 3 > ring.rings.length) && (vertex.angle = a,
                        vertex.positioned = !0)
                ...
                for (var i = 0; i < orderedNeighbours.length; i++) {
                    ...
                    if (2 === vertices.length) {
                        ...
                        -1 === posA.clockwise(posB) ? !neighbour.positioned && this.createRing(neighbour, nextCenter, vertexA, vertexB) : !neighbour.positioned && this.createRing(neighbour, nextCenter, vertexB, vertexA)
                ...
                for (var i = 0; i < ring.members.length; i++) {
                    ...
                    for (var j = 0; j < ringMemberNeighbours.length; j++) {
                        ...
                        v.positioned || (v.value.isConnectedToRing = !0,
            ...
            getSubtreeOverlapScore(vertexId, parentVertexId, vertexOverlapScores) {
                ...
                return this.graph.traverseTree(vertexId, parentVertexId, function(vertex) {
                    if (vertex.value.isDrawn) {
                        ...
                        s > that.opts.overlapSensitivity && (score += s,
                        count++);
            ...
            getCurrentCenterOfMass() {
                ...
                for (var i = 0; i < this.graph.vertices.length; i++) {
                    let vertex = this.graph.vertices[i];
                    vertex.positioned && (total.add(vertex.position),
                    count++)
                }
            ...
            getCurrentCenterOfMassInNeigbourhood(vec, r=2 * this.opts.bondLength) {
                ...
                for (var i = 0; i < this.graph.vertices.length; i++) {
                    let vertex = this.graph.vertices[i];
                    vertex.positioned && vec.distanceSq(vertex.position) < r * r && (total.add(vertex.position),
                    count++)
                }
                return total.divide(count)
            }
            resolvePrimaryOverlaps() {
                ...
                for (var i = 0; i < overlaps.length; i++) {
                    ...
                    if (2 === overlap.vertices.length) {
                        ...
                        subTreeOverlapA = this.getSubtreeOverlapScore(a.id, overlap.common.id, overlapScore.vertexScores),
                        subTreeOverlapB = this.getSubtreeOverlapScore(b.id, overlap.common.id, overlapScore.vertexScores),
                        subTreeOverlapA.value + subTreeOverlapB.value > total && (this.rotateSubtree(a.id, overlap.common.id, 2 * angle, overlap.common.position),
                        this.rotateSubtree(b.id, overlap.common.id, -2 * angle, overlap.common.position))
                    } else
            ...
            createNextBond(vertex, previousVertex=null, angle=0, originShortest=!1, skipPositioning=!1) {
                ...
                if (previousVertex) {
                    ...
                    ("/" === edge.bondType || "\\" === edge.bondType) && 1 == ++this.doubleBondConfigCount % 2 && null === this.doubleBondConfig && (this.doubleBondConfig = edge.bondType,
                    doubleBondConfigSet = !0,
                    null === previousVertex.parentVertexId && vertex.value.branchBond && ("/" === this.doubleBondConfig ? this.doubleBondConfig = "\\" : "\\" === this.doubleBondConfig && (this.doubleBondConfig = "/")))
                }
                if (!skipPositioning)
                    if (!previousVertex) {
                ...
                if (null !== vertex.value.bridgedRing) {
                    ...
                    for (var i = 0; i < tmpNeighbours.length; i++)
                        this.graph.vertices[tmpNeighbours[i]].value.isDrawn && neighbours.push(tmpNeighbours[i]);
                    ...
                    if (1 === neighbours.length) {
                        ...
                        if ("#" === vertex.value.bondType || previousVertex && "#" === previousVertex.value.bondType || "=" === vertex.value.bondType && previousVertex && 0 === previousVertex.value.rings.length && "=" === previousVertex.value.bondType && "-" !== vertex.value.branchBond) {
                            if (vertex.value.drawExplicit = !1,
                            previousVertex) {
                            ...
                            ("#" === vertex.value.bondType || previousVertex && "#" === previousVertex.value.bondType) && (nextVertex.angle = 0),
                            ...
                            if (previousVertex && 3 < previousVertex.neighbours.length)
                                a = 0 < a ? _Mathmin3(1.0472, a) : 0 > a ? _Mathmax2(-1.0472, a) : 1.0472;
                            else if (!a) {
                            ...
                            if (previousVertex && !doubleBondConfigSet) {
                                ...
                                "/" === bondType ? ("/" === this.doubleBondConfig || "\\" === this.doubleBondConfig && (a = -a),
                                this.doubleBondConfig = null) : "\\" === bondType && ("/" === this.doubleBondConfig ? a = -a : "\\" === this.doubleBondConfig,
                                this.doubleBondConfig = null)
                            }
                        ...
                        let cis = 0
                          , trans = 1;
                        "C" === r.value.element && "C" !== l.value.element && 1 < subTreeDepthB && 5 > subTreeDepthA ? (cis = 1,
                        trans = 0) : "C" !== r.value.element && "C" === l.value.element && 1 < subTreeDepthA && 5 > subTreeDepthB ? (cis = 0,
                        trans = 1) : subTreeDepthB > subTreeDepthA && (cis = 1,
                        trans = 0);
                        let cisVertex = this.graph.vertices[neighbours[cis]]
                          ...
                          , originShortest = !1;
                        subTreeDepthC < subTreeDepthA && subTreeDepthC < subTreeDepthB && (originShortest = !0),
                        transVertex.angle = a,
                        cisVertex.angle = -a,
                        "\\" === this.doubleBondConfig ? "\\" === transVertex.value.branchBond && (transVertex.angle = -a,
                        cisVertex.angle = a) : "/" === this.doubleBondConfig && "/" === transVertex.value.branchBond && (transVertex.angle = -a,
                        cisVertex.angle = a),
                        ...
                        d2 > d1 && d2 > d3 ? (s = this.graph.vertices[neighbours[1]],
                        l = this.graph.vertices[neighbours[0]],
                        r = this.graph.vertices[neighbours[2]]) : d3 > d1 && d3 > d2 && (s = this.graph.vertices[neighbours[2]],
                        l = this.graph.vertices[neighbours[0]],
                        r = this.graph.vertices[neighbours[1]]),
                        previousVertex && 1 > previousVertex.value.rings.length && 1 > s.value.rings.length && 1 > l.value.rings.length && 1 > r.value.rings.length && 1 === this.graph.getTreeDepth(l.id, vertex.id) && 1 === this.graph.getTreeDepth(r.id, vertex.id) && 1 < this.graph.getTreeDepth(s.id, vertex.id) ? (s.angle = -vertex.angle,
                        0 <= vertex.angle ? (l.angle = MathHelper.toRad(30),
                        r.angle = MathHelper.toRad(90)) : (l.angle = -MathHelper.toRad(30),
                        ...
                        this.createNextBond(r, vertex, previousAngle + r.angle)) : (s.angle = 0,
                        ...
                        d2 > d1 && d2 > d3 && d2 > d4 ? (w = this.graph.vertices[neighbours[1]],
                        x = this.graph.vertices[neighbours[0]],
                        y = this.graph.vertices[neighbours[2]],
                        z = this.graph.vertices[neighbours[3]]) : d3 > d1 && d3 > d2 && d3 > d4 ? (w = this.graph.vertices[neighbours[2]],
                        x = this.graph.vertices[neighbours[0]],
                        y = this.graph.vertices[neighbours[1]],
                        z = this.graph.vertices[neighbours[3]]) : d4 > d1 && d4 > d2 && d4 > d3 && (w = this.graph.vertices[neighbours[3]],
                        x = this.graph.vertices[neighbours[0]],
                        y = this.graph.vertices[neighbours[1]],
            ...
            isPointInRing(vec) {
                for (var i = 0; i < this.rings.length; i++) {
                    ...
                    if (vec.distanceSq(ring.center) < radius * radius)
                        return !0
                }
                return !1
            }
                ...
                for (var i = 0; i < this.graph.vertices.length; i++) {
                    ...
                    for (var j = 0; j < priorities.length; j++) {
                        ...
                        for (var k = 0; k < priorities[j][1].length; k++)
                            priorities[j][1][k].length > maxEntries && (maxEntries = priorities[j][1][k].length)
                    }
                    for (var j = 0; j < priorities.length; j++) {
                    ...
                    let posA = this.graph.vertices[neighbours[order[0]]].position
                      ...
                      , wedgeA = "down"
                      , wedgeB = "up";
                    (isCw && "R" !== rs || !isCw && "S" !== rs) && (vertex.value.hydrogenDirection = "up",
                    wedgeA = "up",
                    wedgeB = "down"),
                    vertex.value.hasHydrogen && (this.graph.getEdge(vertex.id, neighbours[order[order.length - 1]]).wedge = wedgeA);
                    ...
                    !showHydrogen) {
                        ...
                        if (vertex.value.hasHydrogen)
                            ...
                            let wedge = wedgeB;
                            for (var j = order.length - 1; 0 <= j && (wedge = wedge === wedgeA ? wedgeB : wedgeA,
                            neighbours[order[j]] !== wedgeId); j--)
                                ;
            ...
            visitStereochemistry(vertexId, previousVertexId, visited, priority, maxDepth, depth, parentAtomicNumber=0) {
                ...
                for (var i = 0; i < neighbours.length; i++)
                    1 !== visited[neighbours[i]] && depth < maxDepth - 1 && this.visitStereochemistry(neighbours[i], vertexId, visited.slice(), priority, maxDepth, depth + 1, atomicNumber);
                if (depth < maxDepth - 1) {
                    let bonds = 0;
                    for (var i = 0; i < neighbours.length; i++)
            ...
            initPseudoElements() {
                for (var i = 0; i < this.graph.vertices.length; i++) {
                    ...
                    if (3 > vertex.getNeighbourCount() || 0 < vertex.value.rings.length)
                        continue;
                    if ("P" === vertex.value.element)
                        continue;
                    if ("C" === vertex.value.element && 3 === neighbours.length && "N" === neighbours[0].value.element && "N" === neighbours[1].value.element && "N" === neighbours[2].value.element)
                        continue;
                    ...
                    for (var j = 0; j < neighbours.length; j++) {
                        ...
                        "C" !== neighbouringElement && "H" !== neighbouringElement && 1 === neighbourCount && heteroAtomCount++,
                        1 < neighbourCount && ctn++
                    }
                    if (1 < ctn || 2 > heteroAtomCount)
                        continue;
                    let previous = null;
                    for (var j = 0; j < neighbours.length; j++) {
                        let neighbour = neighbours[j];
                ...
                for (var i = 0; i < this.graph.vertices.length; i++) {
                    const vertex = this.graph.vertices[i]
                      , atom = vertex.value
                      , element = atom.element;
                    if ("C" === element || "H" === element || !atom.isDrawn)
                        continue;
                    ...
                    for (var j = 0; j < neighbours.length; j++) {
                        ...
                        if (!neighbour.hasAttachedPseudoElements || 2 !== neighbour.getAttachedPseudoElementsCount())
                            continue;
                        const pseudoElements = neighbour.getAttachedPseudoElements();
                        pseudoElements.hasOwnProperty("0O") && pseudoElements.hasOwnProperty("3C") && (neighbour.isDrawn = !1,
    ...
    7: [function(require, module) {
        ...
        class Graph {
            ...
            _init(node, order=0, parentVertexId=null, isBranch=!1) {
                ...
                null !== parentVertexId) {
                    ...
                    let edge = new Edge(parentVertexId,vertex.id,1)
                      , vertexId = null;
                    isBranch ? (edge.setBondType(vertex.value.branchBond || "-"),
                    vertexId = vertex.id,
                    edge.setBondType(vertex.value.branchBond || "-"),
                    vertexId = vertex.id) : (edge.setBondType(parentVertex.value.bondType || "-"),
            ...
            addVertex(vertex) {
                return vertex.id = this.vertices.length,
            ...
            addEdge(edge) {
                ...
                return edge.id = this.edges.length,
            ...
            getAdjacencyList() {
                ...
                for (var i = 0; i < length; i++) {
                    adjacencyList[i] = [];
                    for (var j = 0; j < length; j++)
                        i !== j && this.hasEdge(this.vertices[i].id, this.vertices[j].id) && adjacencyList[i].push(j)
                }
            ...
            traverseBF(startVertexId, callback) {
                ...
                for (var queue = [startVertexId]; 0 < queue.length; ) {
                    ...
                    for (var i = 0; i < vertex.neighbours.length; i++) {
                        ...
                        visited[v] || (visited[v] = !0,
                        queue.push(v))
                    }
                }
            }
            getTreeDepth(vertexId, parentVertexId) {
                if (null === vertexId || null === parentVertexId)
                    return 0;
            ...
            traverseTree(vertexId, parentVertexId, callback, maxDepth=999999, ignoreFirst=!1, depth=1, visited=null) {
                if (null === visited && (visited = new Uint8Array(this.vertices.length)),
            ...
            kkLayout(vertexIds, center, startVertexId, ring, bondLength, threshold=.1, innerThreshold=.1, maxIteration=2e3, maxInnerIteration=50, maxEnergy=1e9) {
                ...
                for (i = length; i--; ) {
                    let vertex = this.vertices[vertexIds[i]];
                    vertex.positioned ? (arrPositionX[i] = vertex.position.x,
                    arrPositionY[i] = vertex.position.y) : (arrPositionX[i] = center.x + Math.cos(a) * radius,
                ...
                for (let ux, uy, dEx, dEy, vx, vy, denom; i--; ) {
                    ...
                    dEy = 0;
                    for (let j = length; j--; )
                        i !== j && (vx = arrPositionX[j],
                        vy = arrPositionY[j],
                        denom = 1 / _Mathsqrt2((ux - vx) * (ux - vx) + (uy - vy) * (uy - vy)),
                ...
                let energy = function(index) {
                  ...
                  , highestEnergy = function() {
                    ...
                    for (i = length; i--; ) {
                        ...
                        delta > maxEnergy && !1 === arrPositioned[i] && (maxEnergy = delta,
                        maxEnergyId = i,
                        maxDEX = dEX,
                        maxDEY = dEY)
                    }
                ...
                for (; maxEnergy > threshold && maxIteration > iteration; )
                    ...
                    delta = maxEnergy,
                    innerIteration = 0; delta > innerThreshold && maxInnerIteration > innerIteration; )
                        innerIteration++,
            ...
            _bridgeDfs(u, visited, disc, low, parent, adj, outBridges) {
                ...
                for (var i = 0; i < adj[u].length; i++) {
                    let v = adj[u][i];
                    visited[v] ? v !== parent[u] && (low[u] = _Mathmin4(low[u], disc[v])) : (parent[v] = u,
    ...
    8: [function(require, module) {
        ...
        class Line {
            ...
            setRightVector(x, y) {
                return this.from.x < this.to.x ? (this.to.x = x,
                this.to.y = y) : (this.from.x = x,
                this.from.y = y),
                this
            }
            setLeftVector(x, y) {
                return this.from.x < this.to.x ? (this.from.x = x,
                this.from.y = y) : (this.to.x = x,
                this.to.y = y),
                this
            }
            rotateToXAxis() {
                let left = this.getLeftVector();
                return this.setRightVector(left.x + this.getLength(), left.y),
                this
            }
            rotate(theta) {
                ...
                return this.setRightVector(x, y),
                this
            }
            shortenFrom(by) {
            ...
            shortenRight(by) {
                return this.from.x < this.to.x ? this.shortenTo(by) : this.shortenFrom(by),
                this
            }
            shortenLeft(by) {
                return this.from.x < this.to.x ? this.shortenFrom(by) : this.shortenTo(by),
                this
            }
            shorten(by) {
                let f = Vector2.subtract(this.from, this.to);
    ...
    9: [function(require, module) {
        ...
        class MathHelper {
            static round(value, decimals) {
                return decimals = decimals ? decimals : 1,
            ...
            static parityOfPermutation(arr) {
                let visited = new Uint8Array(arr.length)
                  ...
                  , traverseCycle = function(i, cycleLength=0) {
                    return 1 === visited[i] ? cycleLength : (cycleLength++,
                    visited[i] = 1,
        ...
        module.exports = function() {
            ...
            function peg$parse(input, options) {
                ...
                function peg$computePosDetails(pos) {
                    ...
                    if (details)
                        return details;
                    for (p = pos - 1; !peg$posDetailsCache[p]; )
                        p--;
                    for (details = peg$posDetailsCache[p],
                    details = {
                        line: details.line,
                        column: details.column
                    }; p < pos; )
                        10 === input.charCodeAt(p) ? (details.line++,
                        details.column = 1) : details.column++,
                        p++;
                    return peg$posDetailsCache[pos] = details,
                    details
                }
                ...
                function peg$fail(expected) {
                    peg$currPos < peg$maxFailPos || (peg$currPos > peg$maxFailPos && (peg$maxFailPos = peg$currPos,
                    peg$maxFailExpected = []),
                ...
                function peg$parsechain() {
                    ...
                    s2 !== peg$FAILED) {
                        for (s3 = [],
                        s4 = peg$parsebranch(); s4 !== peg$FAILED; )
                            s3.push(s4),
                            s4 = peg$parsebranch();
                        if (s3 !== peg$FAILED) {
                            for (s4 = [],
                            ...
                            s6 === peg$FAILED ? (peg$currPos = s5,
                            s5 = peg$FAILED) : (s7 = peg$parsering(),
                            s7 === peg$FAILED ? (peg$currPos = s5,
                            s5 = peg$FAILED) : (s6 = [s6, s7],
                            s5 = s6)); s5 !== peg$FAILED; )
                                s4.push(s5),
                                s5 = peg$currPos,
                                s6 = peg$parsebond(),
                            ...
                            if (s4 !== peg$FAILED) {
                                for (s5 = [],
                                s6 = peg$parsebranch(); s6 !== peg$FAILED; )
                                    s5.push(s6),
                                    s6 = peg$parsebranch();
                                if (s5 === peg$FAILED)
                                    peg$currPos = s1,
                                    s1 = peg$FAILED;
                                else if (s6 = peg$parsebond(),
                                s6 === peg$FAILED && (s6 = null),
                                s6 === peg$FAILED)
                                    peg$currPos = s1,
                                    s1 = peg$FAILED;
                                else if (s7 = peg$parsechain(),
                                s7 === peg$FAILED && (s7 = null),
                                s7 !== peg$FAILED) {
                                    for (s8 = [],
                                    s9 = peg$parsebranch(); s9 !== peg$FAILED; )
                                        s8.push(s9),
                                        s9 = peg$parsebranch();
                                    s8 === peg$FAILED ? (peg$currPos = s1,
                                    s1 = peg$FAILED) : (s2 = [s2, s3, s4, s5, s6, s7, s8],
                                    s1 = s2)
                                } else
                                    peg$currPos = s1,
                                    s1 = peg$FAILED
                        ...
                        peg$currPos = s1,
                        s1 = peg$FAILED;
                    return s1 !== peg$FAILED && (peg$savedPos = s0,
                    s1 = peg$c0(s1)),
                    s0 = s1,
                    s0
                }
                function peg$parsebranch() {
                    ...
                    return s0 = peg$currPos,
                    s1 = peg$currPos,
                    40 === input.charCodeAt(peg$currPos) ? (s2 = "(",
                    peg$currPos++) : (s2 = peg$FAILED,
                    peg$fail(peg$c2)),
                    s2 === peg$FAILED ? (peg$currPos = s1,
                    s1 = peg$FAILED) : (s3 = peg$parsebond(),
                    s3 === peg$FAILED && (s3 = null),
                    s3 === peg$FAILED ? (peg$currPos = s1,
                    s1 = peg$FAILED) : (s4 = peg$parsechain(),
                    s4 === peg$FAILED ? (peg$currPos = s1,
                    s1 = peg$FAILED) : (41 === input.charCodeAt(peg$currPos) ? (s5 = ")",
                    peg$currPos++) : (s5 = peg$FAILED,
                    peg$fail(peg$c4)),
                    s5 === peg$FAILED ? (peg$currPos = s1,
                    s1 = peg$FAILED) : (s2 = [s2, s3, s4, s5],
                    s1 = s2)))),
                ...
                function peg$parseatom() {
                    ...
                    s1 === peg$FAILED && (s1 = peg$parsearomaticsymbol(),
                    s1 === peg$FAILED && (s1 = peg$parsebracketatom(),
                ...
                function peg$parsebond() {
                    var s0, s1;
                    if (s0 = peg$currPos,
                    peg$c7.test(input.charAt(peg$currPos))) {
                        if (s1 = input.charAt(peg$currPos),
                        s1 === input.charAt(peg$currPos + 1))
                            throw s1 = peg$FAILED,
                            peg$buildSimpleError("The parser encountered a bond repetition.", peg$currPos + 1);
                        peg$currPos++
                    } else
                        s1 = peg$FAILED,
                        peg$fail(peg$c8);
                ...
                function peg$parsebracketatom() {
                    ...
                    return s0 = peg$currPos,
                    s1 = peg$currPos,
                    91 === input.charCodeAt(peg$currPos) ? (s2 = "[",
                    peg$currPos++) : (s2 = peg$FAILED,
                    peg$fail(peg$c11)),
                    s2 === peg$FAILED ? (peg$currPos = s1,
                    s1 = peg$FAILED) : (s3 = peg$parseisotope(),
                    s3 === peg$FAILED && (s3 = null),
                    s3 === peg$FAILED ? (peg$currPos = s1,
                    s1 = peg$FAILED) : ("se" === input.substr(peg$currPos, 2) ? (s4 = "se",
                    peg$currPos += 2) : (s4 = peg$FAILED,
                    peg$fail(peg$c13)),
                    s4 === peg$FAILED && ("as" === input.substr(peg$currPos, 2) ? (s4 = "as",
                    peg$currPos += 2) : (s4 = peg$FAILED,
                    peg$fail(peg$c15)),
                    s4 === peg$FAILED && (s4 = peg$parsearomaticsymbol(),
                    s4 === peg$FAILED && (s4 = peg$parseelementsymbol(),
                    s4 === peg$FAILED && (s4 = peg$parsewildcard())))),
                    s4 === peg$FAILED ? (peg$currPos = s1,
                    s1 = peg$FAILED) : (s5 = peg$parsechiral(),
                    s5 === peg$FAILED && (s5 = null),
                    s5 === peg$FAILED ? (peg$currPos = s1,
                    s1 = peg$FAILED) : (s6 = peg$parsehcount(),
                    s6 === peg$FAILED && (s6 = null),
                    s6 === peg$FAILED ? (peg$currPos = s1,
                    s1 = peg$FAILED) : (s7 = peg$parsecharge(),
                    s7 === peg$FAILED && (s7 = null),
                    s7 === peg$FAILED ? (peg$currPos = s1,
                    s1 = peg$FAILED) : (s8 = peg$parseclass(),
                    s8 === peg$FAILED && (s8 = null),
                    s8 === peg$FAILED ? (peg$currPos = s1,
                    s1 = peg$FAILED) : (93 === input.charCodeAt(peg$currPos) ? (s9 = "]",
                    peg$currPos++) : (s9 = peg$FAILED,
                    peg$fail(peg$c17)),
                    s9 === peg$FAILED ? (peg$currPos = s1,
                    s1 = peg$FAILED) : (s2 = [s2, s3, s4, s5, s6, s7, s8, s9],
                    s1 = s2)))))))),
                    s1 !== peg$FAILED && (peg$savedPos = s0,
                    s1 = peg$c18(s1)),
                    s0 = s1,
                ...
                function peg$parseorganicsymbol() {
                    ...
                    return s0 = peg$currPos,
                    s1 = peg$currPos,
                    66 === input.charCodeAt(peg$currPos) ? (s2 = "B",
                    peg$currPos++) : (s2 = peg$FAILED,
                    peg$fail(peg$c20)),
                    s2 === peg$FAILED ? (peg$currPos = s1,
                    s1 = peg$FAILED) : (114 === input.charCodeAt(peg$currPos) ? (s3 = "r",
                    peg$currPos++) : (s3 = peg$FAILED,
                    peg$fail(peg$c22)),
                    s3 === peg$FAILED && (s3 = null),
                    s3 === peg$FAILED ? (peg$currPos = s1,
                    s1 = peg$FAILED) : (s2 = [s2, s3],
                    s1 = s2)),
                    s1 === peg$FAILED && (s1 = peg$currPos,
                    67 === input.charCodeAt(peg$currPos) ? (s2 = "C",
                    peg$currPos++) : (s2 = peg$FAILED,
                    peg$fail(peg$c24)),
                    s2 === peg$FAILED ? (peg$currPos = s1,
                    s1 = peg$FAILED) : (108 === input.charCodeAt(peg$currPos) ? (s3 = "l",
                    peg$currPos++) : (s3 = peg$FAILED,
                    peg$fail(peg$c26)),
                    s3 === peg$FAILED && (s3 = null),
                    s3 === peg$FAILED ? (peg$currPos = s1,
                    s1 = peg$FAILED) : (s2 = [s2, s3],
                    s1 = s2)),
                    s1 === peg$FAILED && (peg$c27.test(input.charAt(peg$currPos)) ? (s1 = input.charAt(peg$currPos),
                    peg$currPos++) : (s1 = peg$FAILED,
                    peg$fail(peg$c28)))),
                    s1 !== peg$FAILED && (peg$savedPos = s0,
                    s1 = peg$c29(s1)),
                    s0 = s1,
                ...
                function peg$parsearomaticsymbol() {
                    var s0, s1;
                    return s0 = peg$currPos,
                    peg$c30.test(input.charAt(peg$currPos)) ? (s1 = input.charAt(peg$currPos),
                    peg$currPos++) : (s1 = peg$FAILED,
                    peg$fail(peg$c31)),
                    s1 !== peg$FAILED && (peg$savedPos = s0,
                    s1 = peg$c6(s1)),
                ...
                function peg$parsewildcard() {
                    var s0, s1;
                    return s0 = peg$currPos,
                    42 === input.charCodeAt(peg$currPos) ? (s1 = "*",
                    peg$currPos++) : (s1 = peg$FAILED,
                    peg$fail(peg$c33)),
                    s1 !== peg$FAILED && (peg$savedPos = s0,
                    s1 = peg$c34(s1)),
                ...
                function peg$parseelementsymbol() {
                    ...
                    return s0 = peg$currPos,
                    s1 = peg$currPos,
                    peg$c35.test(input.charAt(peg$currPos)) ? (s2 = input.charAt(peg$currPos),
                    peg$currPos++) : (s2 = peg$FAILED,
                    peg$fail(peg$c36)),
                    s2 === peg$FAILED ? (peg$currPos = s1,
                    s1 = peg$FAILED) : (peg$c37.test(input.charAt(peg$currPos)) ? (s3 = input.charAt(peg$currPos),
                    peg$currPos++) : (s3 = peg$FAILED,
                    peg$fail(peg$c38)),
                    s3 === peg$FAILED && (s3 = null),
                    s3 === peg$FAILED ? (peg$currPos = s1,
                ...
                function peg$parsering() {
                    ...
                    return s0 = peg$currPos,
                    s1 = peg$currPos,
                    37 === input.charCodeAt(peg$currPos) ? (s2 = "%",
                    peg$currPos++) : (s2 = peg$FAILED,
                    peg$fail(peg$c41)),
                    s2 === peg$FAILED ? (peg$currPos = s1,
                    s1 = peg$FAILED) : (peg$c42.test(input.charAt(peg$currPos)) ? (s3 = input.charAt(peg$currPos),
                    peg$currPos++) : (s3 = peg$FAILED,
                    peg$fail(peg$c43)),
                    s3 === peg$FAILED ? (peg$currPos = s1,
                    s1 = peg$FAILED) : (peg$c44.test(input.charAt(peg$currPos)) ? (s4 = input.charAt(peg$currPos),
                    peg$currPos++) : (s4 = peg$FAILED,
                    peg$fail(peg$c45)),
                    s4 === peg$FAILED ? (peg$currPos = s1,
                    s1 = peg$FAILED) : (s2 = [s2, s3, s4],
                    s1 = s2))),
                    s1 === peg$FAILED && (peg$c44.test(input.charAt(peg$currPos)) ? (s1 = input.charAt(peg$currPos),
                    peg$currPos++) : (s1 = peg$FAILED,
                    peg$fail(peg$c45))),
                    s1 !== peg$FAILED && (peg$savedPos = s0,
                    s1 = peg$c46(s1)),
                ...
                function peg$parsechiral() {
                    ...
                    return s0 = peg$currPos,
                    s1 = peg$currPos,
                    64 === input.charCodeAt(peg$currPos) ? (s2 = "@",
                    peg$currPos++) : (s2 = peg$FAILED,
                    peg$fail(peg$c48)),
                    s2 === peg$FAILED ? (peg$currPos = s1,
                    s1 = peg$FAILED) : (64 === input.charCodeAt(peg$currPos) ? (s3 = "@",
                    peg$currPos++) : (s3 = peg$FAILED,
                    peg$fail(peg$c48)),
                    s3 === peg$FAILED && (s3 = peg$currPos,
                    "TH" === input.substr(peg$currPos, 2) ? (s4 = "TH",
                    peg$currPos += 2) : (s4 = peg$FAILED,
                    peg$fail(peg$c50)),
                    s4 === peg$FAILED ? (peg$currPos = s3,
                    s3 = peg$FAILED) : (peg$c51.test(input.charAt(peg$currPos)) ? (s5 = input.charAt(peg$currPos),
                    peg$currPos++) : (s5 = peg$FAILED,
                    peg$fail(peg$c52)),
                    s5 === peg$FAILED ? (peg$currPos = s3,
                    s3 = peg$FAILED) : (s4 = [s4, s5],
                    s3 = s4)),
                    s3 === peg$FAILED && (s3 = peg$currPos,
                    "AL" === input.substr(peg$currPos, 2) ? (s4 = "AL",
                    peg$currPos += 2) : (s4 = peg$FAILED,
                    peg$fail(peg$c54)),
                    s4 === peg$FAILED ? (peg$currPos = s3,
                    s3 = peg$FAILED) : (peg$c51.test(input.charAt(peg$currPos)) ? (s5 = input.charAt(peg$currPos),
                    ...
                    s3 = s4)),
                    s3 === peg$FAILED && (s3 = peg$currPos,
                    "SP" === input.substr(peg$currPos, 2) ? (s4 = "SP",
                    peg$currPos += 2) : (s4 = peg$FAILED,
                    peg$fail(peg$c56)),
                    s4 === peg$FAILED ? (peg$currPos = s3,
                    s3 = peg$FAILED) : (peg$c57.test(input.charAt(peg$currPos)) ? (s5 = input.charAt(peg$currPos),
                    peg$currPos++) : (s5 = peg$FAILED,
                    peg$fail(peg$c58)),
                    s5 === peg$FAILED ? (peg$currPos = s3,
                    s3 = peg$FAILED) : (s4 = [s4, s5],
                    s3 = s4)),
                    s3 === peg$FAILED && (s3 = peg$currPos,
                    "TB" === input.substr(peg$currPos, 2) ? (s4 = "TB",
                    peg$currPos += 2) : (s4 = peg$FAILED,
                    peg$fail(peg$c60)),
                    s4 === peg$FAILED ? (peg$currPos = s3,
                    s3 = peg$FAILED) : (peg$c42.test(input.charAt(peg$currPos)) ? (s5 = input.charAt(peg$currPos),
                    peg$currPos++) : (s5 = peg$FAILED,
                    peg$fail(peg$c43)),
                    s5 === peg$FAILED ? (peg$currPos = s3,
                    s3 = peg$FAILED) : (peg$c44.test(input.charAt(peg$currPos)) ? (s6 = input.charAt(peg$currPos),
                    peg$currPos++) : (s6 = peg$FAILED,
                    peg$fail(peg$c45)),
                    s6 === peg$FAILED && (s6 = null),
                    s6 === peg$FAILED ? (peg$currPos = s3,
                    s3 = peg$FAILED) : (s4 = [s4, s5, s6],
                    s3 = s4))),
                    s3 === peg$FAILED && (s3 = peg$currPos,
                    "OH" === input.substr(peg$currPos, 2) ? (s4 = "OH",
                    peg$currPos += 2) : (s4 = peg$FAILED,
                    peg$fail(peg$c62)),
                    s4 === peg$FAILED ? (peg$currPos = s3,
                    s3 = peg$FAILED) : (peg$c42.test(input.charAt(peg$currPos)) ? (s5 = input.charAt(peg$currPos),
                ...
                function peg$parseposcharge() {
                    ...
                    return s0 = peg$currPos,
                    s1 = peg$currPos,
                    43 === input.charCodeAt(peg$currPos) ? (s2 = "+",
                    peg$currPos++) : (s2 = peg$FAILED,
                    peg$fail(peg$c66)),
                    s2 === peg$FAILED ? (peg$currPos = s1,
                    s1 = peg$FAILED) : (43 === input.charCodeAt(peg$currPos) ? (s3 = "+",
                    peg$currPos++) : (s3 = peg$FAILED,
                    peg$fail(peg$c66)),
                    s3 === peg$FAILED && (s3 = peg$currPos,
                    peg$c42.test(input.charAt(peg$currPos)) ? (s4 = input.charAt(peg$currPos),
                    peg$currPos++) : (s4 = peg$FAILED,
                    peg$fail(peg$c43)),
                    s4 === peg$FAILED ? (peg$currPos = s3,
                    s3 = peg$FAILED) : (peg$c44.test(input.charAt(peg$currPos)) ? (s5 = input.charAt(peg$currPos),
                    peg$currPos++) : (s5 = peg$FAILED,
                    peg$fail(peg$c45)),
                    s5 === peg$FAILED && (s5 = null),
                    s5 === peg$FAILED ? (peg$currPos = s3,
                ...
                function peg$parsenegcharge() {
                    ...
                    return s0 = peg$currPos,
                    s1 = peg$currPos,
                    45 === input.charCodeAt(peg$currPos) ? (s2 = "-",
                    peg$currPos++) : (s2 = peg$FAILED,
                    peg$fail(peg$c69)),
                    s2 === peg$FAILED ? (peg$currPos = s1,
                    s1 = peg$FAILED) : (45 === input.charCodeAt(peg$currPos) ? (s3 = "-",
                    peg$currPos++) : (s3 = peg$FAILED,
                    peg$fail(peg$c69)),
                    s3 === peg$FAILED && (s3 = peg$currPos,
                    peg$c42.test(input.charAt(peg$currPos)) ? (s4 = input.charAt(peg$currPos),
                ...
                function peg$parsehcount() {
                    ...
                    return s0 = peg$currPos,
                    s1 = peg$currPos,
                    72 === input.charCodeAt(peg$currPos) ? (s2 = "H",
                    peg$currPos++) : (s2 = peg$FAILED,
                    peg$fail(peg$c72)),
                    s2 === peg$FAILED ? (peg$currPos = s1,
                    s1 = peg$FAILED) : (peg$c44.test(input.charAt(peg$currPos)) ? (s3 = input.charAt(peg$currPos),
                    peg$currPos++) : (s3 = peg$FAILED,
                    peg$fail(peg$c45)),
                    s3 === peg$FAILED && (s3 = null),
                    s3 === peg$FAILED ? (peg$currPos = s1,
                ...
                function peg$parseclass() {
                    ...
                    if (s0 = peg$currPos,
                    s1 = peg$currPos,
                    58 === input.charCodeAt(peg$currPos) ? (s2 = ":",
                    peg$currPos++) : (s2 = peg$FAILED,
                    peg$fail(peg$c75)),
                    s2 !== peg$FAILED) {
                        if (s3 = peg$currPos,
                        ...
                        s4 !== peg$FAILED) {
                            for (s5 = [],
                            peg$c44.test(input.charAt(peg$currPos)) ? (s6 = input.charAt(peg$currPos),
                            peg$currPos++) : (s6 = peg$FAILED,
                            peg$fail(peg$c45)); s6 !== peg$FAILED; )
                                s5.push(s6),
                                peg$c44.test(input.charAt(peg$currPos)) ? (s6 = input.charAt(peg$currPos),
                                peg$currPos++) : (s6 = peg$FAILED,
                                peg$fail(peg$c45));
                            ...
                            peg$currPos = s3,
                            s3 = peg$FAILED;
                        s3 === peg$FAILED && (peg$c76.test(input.charAt(peg$currPos)) ? (s3 = input.charAt(peg$currPos),
                        peg$currPos++) : (s3 = peg$FAILED,
                        peg$fail(peg$c77))),
                        s3 === peg$FAILED ? (peg$currPos = s1,
                        s1 = peg$FAILED) : (s2 = [s2, s3],
                ...
                function peg$parseisotope() {
                    ...
                    return s0 = peg$currPos,
                    s1 = peg$currPos,
                    peg$c42.test(input.charAt(peg$currPos)) ? (s2 = input.charAt(peg$currPos),
                    peg$currPos++) : (s2 = peg$FAILED,
                    peg$fail(peg$c43)),
                    s2 === peg$FAILED ? (peg$currPos = s1,
                    s1 = peg$FAILED) : (peg$c44.test(input.charAt(peg$currPos)) ? (s3 = input.charAt(peg$currPos),
                ...
                }, peg$c2 = peg$literalExpectation("(", !1), peg$c4 = peg$literalExpectation(")", !1), peg$c5 = function(b) {
                    var bond = b[1] ? b[1] : "-";
                    return b[2].branchBond = bond,
                    b[2]
                }, peg$c6 = function(a) {
                    return a
                }, peg$c7 = /^[\-=#$:\/\\.]/, peg$c8 = peg$classExpectation(["-", "=", "#", "$", ":", "/", "\\", "."], !1, !1), peg$c9 = function(b) {
                    return b
                }, peg$c11 = peg$literalExpectation("[", !1), peg$c13 = peg$literalExpectation("se", !1), peg$c15 = peg$literalExpectation("as", !1), peg$c17 = peg$literalExpectation("]", !1), peg$c18 = function(b) {
                    return {
                        isotope: b[1],
                        element: b[2],
                        chirality: b[3],
                ...
                }, peg$c20 = peg$literalExpectation("B", !1), peg$c22 = peg$literalExpectation("r", !1), peg$c24 = peg$literalExpectation("C", !1), peg$c26 = peg$literalExpectation("l", !1), peg$c27 = /^[NOPSFI]/, peg$c28 = peg$classExpectation(["N", "O", "P", "S", "F", "I"], !1, !1), peg$c29 = function(o) {
                    return 1 < o.length ? o.join("") : o
                }, peg$c30 = /^[bcnops]/, peg$c31 = peg$classExpectation(["b", "c", "n", "o", "p", "s"], !1, !1), peg$c33 = peg$literalExpectation("*", !1), peg$c34 = function(w) {
                    return w
                }, peg$c35 = /^[A-Z]/, peg$c36 = peg$classExpectation([["A", "Z"]], !1, !1), peg$c37 = /^[a-z]/, peg$c38 = peg$classExpectation([["a", "z"]], !1, !1), peg$c39 = function(e) {
                    return e.join("")
                }, peg$c41 = peg$literalExpectation("%", !1), peg$c42 = /^[1-9]/, peg$c43 = peg$classExpectation([["1", "9"]], !1, !1), peg$c44 = /^[0-9]/, peg$c45 = peg$classExpectation([["0", "9"]], !1, !1), peg$c46 = function(r) {
                    return 1 == r.length ? +r : +r.join("").replace("%", "")
                }, peg$c48 = peg$literalExpectation("@", !1), peg$c50 = peg$literalExpectation("TH", !1), peg$c51 = /^[12]/, peg$c52 = peg$classExpectation(["1", "2"], !1, !1), peg$c54 = peg$literalExpectation("AL", !1), peg$c56 = peg$literalExpectation("SP", !1), peg$c57 = /^[1-3]/, peg$c58 = peg$classExpectation([["1", "3"]], !1, !1), peg$c60 = peg$literalExpectation("TB", !1), peg$c62 = peg$literalExpectation("OH", !1), peg$c63 = function(c) {
                    return c[1] ? "@" == c[1] ? "@@" : c[1].join("").replace(",", "") : "@"
                }, peg$c64 = function(c) {
                    return c
                }, peg$c66 = peg$literalExpectation("+", !1), peg$c67 = function(c) {
                    return c[1] ? "+" == c[1] ? 2 : +c[1].join("") : 1
                }, peg$c69 = peg$literalExpectation("-", !1), peg$c70 = function(c) {
                    return c[1] ? "-" == c[1] ? -2 : -+c[1].join("") : -1
                }, peg$c72 = peg$literalExpectation("H", !1), peg$c73 = function(h) {
                    return h[1] ? +h[1] : 1
                }, peg$c75 = peg$literalExpectation(":", !1), peg$c76 = /^[0]/, peg$c77 = peg$classExpectation(["0"], !1, !1), peg$c78 = function(c) {
                ...
                if (peg$result = peg$startRuleFunction(),
            ...
            peg$SyntaxError.buildMessage = function(expected, found) {
                ...
                return "Expected " + function(expected) {
                    var descriptions = Array(expected.length), i, j;
                    for (i = 0; i < expected.length; i++)
                        descriptions[i] = describeExpectation(expected[i]);
                    if (descriptions.sort(),
                    0 < descriptions.length) {
                        for (i = 1,
                        j = 1; i < descriptions.length; i++)
                            descriptions[i - 1] !== descriptions[i] && (descriptions[j] = descriptions[i],
                            j++);
        ...
        class Ring {
            ...
            getOrderedNeighbours(ringConnections) {
                ...
                for (let i = 0, vertices; i < this.neighbours.length; i++)
                    vertices = RingConnection.getVertices(ringConnections, this.id, this.neighbours[i]),
                    orderedNeighbours[i] = {
                        n: vertices.length,
        ...
        module.exports = class {
            constructor(firstRing, secondRing) {
                ...
                for (var m = 0; m < firstRing.members.length; m++) {
                    ...
                    for (let n = 0, d; n < secondRing.members.length; n++)
                        d = secondRing.members[n],
                        c === d && this.addVertex(c)
                }
            }
            addVertex(vertexId) {
            ...
            isBridge(vertices) {
                ...
                for (let vertexId of this.vertices)
                    if (2 < vertices[vertexId].value.rings.length)
                        return !0;
                return !1
            }
            static isBridge(ringConnections, vertices, firstRingId, secondRingId) {
                ...
                for (let i = 0; i < ringConnections.length; i++)
                    if (ringConnection = ringConnections[i],
                    ringConnection.firstRingId === firstRingId && ringConnection.secondRingId === secondRingId || ringConnection.firstRingId === secondRingId && ringConnection.secondRingId === firstRingId)
            ...
            static getNeighbours(ringConnections, ringId) {
                ...
                for (let i = 0, ringConnection; i < ringConnections.length; i++)
                    ...
                    ringConnection.firstRingId === ringId ? neighbours.push(ringConnection.secondRingId) : ringConnection.secondRingId === ringId && neighbours.push(ringConnection.firstRingId);
                return neighbours
            }
        ...
        class SSSR {
            static getRings(graph, experimental=!1) {
                ...
                for (var i = 0; i < connectedComponents.length; i++) {
                    ...
                    if (allThree && (nSssr = 2 + nEdges - ccAdjacencyMatrix.length),
                    1 == nSssr) {
            ...
            static getPathIncludedDistanceMatrices(adjacencyMatrix) {
                ...
                for (var l = 0, m = 0, n = 0, i = length; i--; ) {
                    ...
                    for (var j = length; j--; )
                        d[i][j] = i === j || 1 === adjacencyMatrix[i][j] ? adjacencyMatrix[i][j] : _NumberPOSITIVE_INFINITY,
                        pe[i][j] = 1 === d[i][j] ? [[[i, j]]] : [],
                        pe_prime[i][j] = []
                }
                        ...
                        for (j = length; j--; ) {
                            ...
                            if (previousPathLength > newPathLength) {
                                ...
                                if (previousPathLength === newPathLength + 1)
                                    for (pe_prime[i][j] = [pe[i][j].length],
                                    l = pe[i][j].length; l--; )
                                        for (pe_prime[i][j][l] = [pe[i][j][l].length],
                                        m = pe[i][j][l].length; m--; )
                                            for (pe_prime[i][j][l][m] = [pe[i][j][l][m].length],
                                            n = pe[i][j][l][m].length; n--; )
                                                pe_prime[i][j][l][m][n] = [pe[i][j][l][m][0], pe[i][j][l][m][1]];
                                else
                                    pe_prime[i][j] = [];
                                for (d[i][j] = newPathLength,
                                pe[i][j] = [[]],
                                l = pe[i][k][0].length; l--; )
            ...
            static getRingCandidates(d, pe, pe_prime) {
                ...
                for (let i = 0; i < length; i++)
                    for (let j = 0; j < length; j++)
                        if (0 === d[i][j] || 1 === pe[i][j].length && 0 === pe_prime[i][j])
                            continue;
                        else
                            c = 0 === pe_prime[i][j].length ? 2 * d[i][j] : 2 * (d[i][j] + .5),
                ...
                for (let i = 0; i < c.length; i++)
                    if (0 != c[i][0] % 2)
                        for (let j = 0, bonds; j < c[i][2].length; j++) {
                            ...
                            if (SSSR.getBondCount(atoms, adjacencyMatrix) !== atoms.size || SSSR.pathSetsContain(cSssr, atoms, bonds, allBonds, arrBondCount, arrRingCount) || (cSssr.push(atoms),
            ...
            static pathSetsContain(pathSets, pathSet, bonds, allBonds, arrBondCount, arrRingCount) {
                ...
                for (i = bonds.length; i--; )
                    for (var j = allBonds.length; j--; )
                        (bonds[i][0] === allBonds[j][0] && bonds[i][1] === allBonds[j][1] || bonds[i][1] === allBonds[j][0] && bonds[i][0] === allBonds[j][1]) && count++,
    ...
    14: [function(require, module) {
        ...
        module.exports = class {
            ...
            draw(data, target, themeName="light", infoOnly=!1) {
                ...
                return preprocessor.initDraw(data, themeName, infoOnly),
                infoOnly || (this.themeManager = new ThemeManager(this.preprocessor.opts.themes,themeName),
                ...
                preprocessor.opts.debug && (console.log(preprocessor.graph),
            ...
            drawAromaticityRing(ring) {
                ...
                ctx.lineWidth = this.opts.bondThickness,
                ctx.beginPath(),
                ctx.arc(ring.center.x + this.offsetX, ring.center.y + this.offsetY, radius - this.opts.bondSpacing, 0, 2 * _MathPI3, !0),
                ctx.closePath(),
                ctx.stroke(),
                ctx.restore()
            }
            ...
            drawEdge(edgeId, debug) {
                ...
                if (vertexA.value.isDrawn && vertexB.value.isDrawn || "default" !== preprocessor.opts.atomVisualization) {
                    ...
                    if (sides[0].multiplyScalar(10).add(a),
                    sides[1].multiplyScalar(10).add(a),
                    "=" === edge.bondType || "=" === preprocessor.getRingbondType(vertexA, vertexB) || edge.isPartOfAromaticRing && preprocessor.bridgedRing) {
                        ...
                        if (inRing) {
                            ...
                            edge.isPartOfAromaticRing ? svgWrapper.drawLine(line, !0) : svgWrapper.drawLine(line),
            ...
            drawVertices(debug) {
                ...
                for (var i = graph.vertices.length, i = 0; i < graph.vertices.length; i++) {
                    ...
                    else if (atom.isDrawn && (!isCarbon || atom.drawExplicit || isTerminal || atom.hasAttachedPseudoElements) || 1 === graph.vertices.length)
                        "default" === opts.atomVisualization ? svgWrapper.drawText(vertex.position.x, vertex.position.y, element, hydrogens, dir, isTerminal, charge, isotope, atom.getAttachedPseudoElements()) : "balls" === opts.atomVisualization && svgWrapper.drawBall(vertex.position.x, vertex.position.y, element);
                    else if (2 === vertex.getNeighbourCount() && !0 == vertex.forcePositioned) {
    ...
    15: [function(require, module) {
        ...
        module.exports = class {
            constructor(themeManager, target, options) {
                ...
                for (mask.setAttributeNS(null, "x", 0),
                ...
                this.maskElements.push(mask); this.svg.firstChild; )
            ...
            `));
                ...
                if (paths.setAttributeNS(null, "mask", "url(#text-mask)"),
                this.svg)
                    return this.svg.appendChild(defs),
                    ...
                    return container.appendChild(defs),
            ...
            createGradient(line) {
                ...
                return secondStop.setAttributeNS(null, "stop-color", this.themeManager.getColor(line.getRightElement() || this.themeManager.getColor("C"))),
            ...
            createSubSuperScripts(text, shift) {
                ...
                return elem.setAttributeNS(null, "baseline-shift", shift),
            ...
            determineDimensions(vertices) {
                ...
                this.offsetX = -minX,
                this.offsetY = -minY,
                scaleX < scaleY ? this.offsetY += this.svg.clientHeight / (2 * scale) - this.drawingHeight / 2 : this.offsetX += this.svg.clientWidth / (2 * scale) - this.drawingWidth / 2
            }
            drawBall(x, y, elementName) {
            ...
            drawText(x, y, elementName, hydrogens, direction, isTerminal, charge, isotope, attachedPseudoElement={}) {
                ...
                mask.setAttributeNS(null, "fill", "black"),
                this.maskElements.push(mask),
                /up|down/.test(direction) && !isTerminal && (writingMode = "vertical-rl",
                textOrientation = "upright",
                letterSpacing = "-1px"),
                "down" !== direction || isTerminal ? "up" !== direction || isTerminal ? "left" === direction && (xShift = 2) : xShift = .5 : (xShift = 0,
                yShift = -2),
                "left" !== direction && ("up" !== direction || isTerminal) || (textDirection = "direction: rtl; unicode-bidi: bidi-override;"),
            ...
            `)
                ...
                if (textNode.appendChild(document.createTextNode(elementName)),
                ...
                0 < hydrogens) {
                    ...
                    if (hydrogenElem.setAttributeNS(null, "style", "unicode-bidi: plaintext;"),
                ...
                for (let key in attachedPseudoElement) {
                    ...
                    if (pseudoElementElem.setAttributeNS(null, "style", "unicode-bidi: plaintext;"),
                    ...
                    if (0 < hydrogenCount) {
                        ...
                        if (pseudoHydrogenElem.setAttributeNS(null, "style", "unicode-bidi: plaintext;"),
    ...
    16: [function(require, module) {
        ...
        module.exports = class {
            ...
            getColor(key) {
                ...
                key in this.theme) ? this.theme[key] : this.theme.C
            }
            setTheme(theme) {
    ...
    17: [function(require, module) {
        ...
        module.exports = {
            getChargeText: function(charge) {
                return console.log("in the utility version of getChargeText"),
                1 === charge ? "+" : 2 === charge ? "2+" : -1 === charge ? "-" : -2 === charge ? "2-" : ""
            }
        }
    }
    , {}],
    18: [function(require, module) {
        ...
        class Vector2 {
            constructor(x, y) {
                0 == arguments.length ? (this.x = 0,
                this.y = 0) : 1 == arguments.length ? (this.x = x.x,
                this.y = x.y) : (this.x = x,
                this.y = y)
            }
            clone() {
            ...
            rotate(angle) {
                ...
                return tmp.x = this.x * cosAngle - this.y * sinAngle,
            ...
            rotateTo(vec, center, offsetAngle=0) {
                ...
                return this.rotateAround(angle + offsetAngle, center),
                this
            }
            ...
            isInPolygon(polygon) {
                ...
                for (let i = 0, j = polygon.length - 1; i < polygon.length; j = i++)
                    polygon[i].y > this.y != polygon[j].y > this.y && this.x < (polygon[j].x - polygon[i].x) * (this.y - polygon[i].y) / (polygon[j].y - polygon[i].y) + polygon[i].x && (inside = !inside);
                return inside
            }
            length() {
    ...
    19: [function(require, module) {
        ...
        class Vertex {
            ...
            addRingbondChild(vertexId, ringbondIndex) {
                if (this.children.push(vertexId),
                this.value.bracket) {
                    let index = 1;
                    0 === this.id && 0 === this.value.bracket.hcount && (index = 0),
                    1 === this.value.bracket.hcount && 0 === ringbondIndex && (index = 2),
                    1 === this.value.bracket.hcount && 1 === ringbondIndex && (3 > this.neighbours.length ? index = 2 : index = 3),
                    null === this.value.bracket.hcount && 0 === ringbondIndex && (index = 1),
                    null === this.value.bracket.hcount && 1 === ringbondIndex && (3 > this.neighbours.length ? index = 1 : index = 2),
            ...
            getAngle(referenceVector=null, returnAsDegrees=!1) {
                let u = null;
                return u = referenceVector ? Vector2.subtract(this.position, referenceVector) : Vector2.subtract(this.position, this.previousPosition),
            ...
            getTextDirection(vertices) {
                ...
                let textAngle = MathHelper.meanAngle(angles)
                  , halfPi = _MathPI4 / 2;
                return textAngle = _Mathround2(_Mathround2(textAngle / halfPi) * halfPi),
                2 === textAngle ? "down" : -2 === textAngle ? "up" : 0 === textAngle || -0 === textAngle ? "right" : 3 === textAngle || -3 === textAngle ? "left" : "down"
            }
            ...
            getSpanningTreeNeighbours(vertexId=null) {
                ...
                for (let i = 0; i < this.spanningTreeChildren.length; i++)
                    (void 0 === vertexId || vertexId != this.spanningTreeChildren[i]) && neighbours.push(this.spanningTreeChildren[i]);
                return null != this.parentVertexId && (void 0 === vertexId || vertexId != this.parentVertexId) && neighbours.push(this.parentVertexId),
                neighbours
            }
